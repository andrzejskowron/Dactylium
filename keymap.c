...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_WORKMAN] = LAYOUT_5x6(
     ...
     KC_LSFT,  KC_Z,   KC_X,    KC_M,    KC_C,    KC_V,                     KC_K,    KC_L,    KC_COMM, KC_DOT,  KC_SLSH,  KC_RSFT, \
                       KC_LBRC,KC_MUTE,                                                       KC_PLUS, KC_RBRC,
                                      KC_ENT, KC_LGUI,                        KC_BSPC, KC_SPACE,
                                      KC_LALT,LT(_LOWER, KC_HOME),                        LT(_RAISE, KC_DEL),  KC_RALT,
                                      KC_PGUP, KC_PGDOWN,                     KC_BSLASH, KC_LALT,
        KC_LEFT, KC_UP, KC_DOWN, KC_RIGHT_ KC_ENT,                                  KC_LEFT, KC_UP, KC_DOWN, KC_RIGHT_ KC_ENT
  ),

  [_LOWER] = LAYOUT_5x6(

     KC_TILD, KC_EXLM, KC_AT, KC_HASH,KC_DLR, KC_PERC,                        KC_CIRC,KC_AMPR,KC_ASTR,KC_LPRN,KC_RPRN,KC_DEL,
     _______,_______,_______,_______,_______,KC_LBRC,                        KC_RBRC, KC_MS_BTN1,  KC_MS_UP,  KC_MS_BTN2, _______,KC_PLUS,
     _______,KC_HOME,KC_PGUP,KC_PGDN,KC_END, KC_LPRN,                        KC_RPRN, KC_MS_LEFT,  KC_MS_DOWN,  KC_MS_RIGHT, KC_ACCEL2, KC_PIPE,
  ...
  [_RAISE] = LAYOUT_5x6(
       ...
       _______,_______,_______,_______,_______,KC_LBRC,                        KC_RBRC, KC_MS_BTN1, KC_UP, KC_INS, KC_SLCK,KC_MUTE,
  ...
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   XXXXXXX, XXXXXXX, RGB_MOD, RGB_HUD, RGB_SAD, RGB_VAD,\
                                               _______,_______,            KC_EQL, _______,
                                               _______,_______,            _______,_______,
                                               _______,_______,            _______,_______,
                                               _______,_______,            _______,_______,
    ...
    if (wpm_graph_timer == 0) {
        static void render_logo(void) {
            static const char PROGMEM my_logo[] = {
                ...
                ,
